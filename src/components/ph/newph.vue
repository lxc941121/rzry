...
#newphDiv{
  ...
  .fstbox{
    ...
    .fstDiv{
      ...
      .first{position: absolute;width:37%;background: url(../img/index/ph1.png) top center no-repeat;background-size:100% auto;height:180px;left:50%;margin-left:-18.5%;}
      .second{position: absolute;width:34%;background: url(../img/index/ph2.png) top center no-repeat;background-size:100% auto;height:180px;left:0%}
      .third{position: absolute;width:34%;background: url(../img/index/ph3.png) top center no-repeat;background-size:100% auto;height:180px;right:0%;}
